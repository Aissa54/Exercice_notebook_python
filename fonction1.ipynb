{
 "cells": [
   ...
   "outputs": [
    {
     ...
     "evalue": "expected an indented block (Temp/ipykernel_9520/1043469461.py, line 7)",
     "output_type": "error",
     "traceback": [
      "\u001b[1;36m  File \u001b[1;32m\"C:\\Users\\UTILIS~1\\AppData\\Local\\Temp/ipykernel_9520/1043469461.py\"\u001b[1;36m, line \u001b[1;32m7\u001b[0m\n\u001b[1;33m    function_name(value_1, value_2)\u001b[0m\n\u001b[1;37m    ^\u001b[0m\n\u001b[1;31mIndentationError\u001b[0m\u001b[1;31m:\u001b[0m expected an indented block\n"
     ]
    }
   ],
   "source": [
  ...
  },
  {
   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "Bonjour, bienvenu à l'école Simplon. Il vous faudra beaucoup de courage et de patience :\n",
      "- Anas\n",
      "- Jordan\n",
      "- Lorraine\n"
     ]
   ...
   "source": [
    "def message_acceuil(nom, message):\n",
    "    print(message)\n",
    "    for etudiant in nom:\n",
    "        print(\"- \" + etudiant.title())\n",
    "\n",
    "nom = [\"anas\", \"jordan\", \"lorraine\"]\n",
    "message_acceuil(nom, \"Bonjour, bienvenu à l'école Simplon. Il vous faudra beaucoup de courage et de patience :\")\n"
   ]
  },
  {
   "cell_type": "markdown",
